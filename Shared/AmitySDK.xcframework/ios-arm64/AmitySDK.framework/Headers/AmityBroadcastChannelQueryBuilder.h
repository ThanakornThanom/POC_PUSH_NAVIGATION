//
//  AmityBroadcastChannelQueryBuilder.h
//  AmitySDK
//
...
@interface AmityBroadcastChannelQueryBuilder : NSObject
...
- (nonnull instancetype)initWithChannelQueryFilter:(AmityChannelQueryFilter)filter
