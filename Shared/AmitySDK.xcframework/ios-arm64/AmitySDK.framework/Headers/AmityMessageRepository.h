 ...
 */
- (nonnull AmityObject<AmityMessage *> *)createCustomMessageWithChannelId:(nonnull NSString *)channelId
...
NS_SWIFT_NAME(createTextMessage(channelId:text:tags:parentId:metadata:mentionees:));
 ...
 */
- (nullable AmityObject<AmityMessage *> *)createAudioMessageWithChannelId:(nonnull NSString *)channelId
...
/**
 ...
 @param parentId  The new message parent (note: this cannot be changed later).
 */
- (nonnull AmityObject<AmityMessage *> *)createImageMessageWithChannelId:(nonnull NSString *)channelId
...
/**
 ...
 @param parentId  The new message parent (note: this cannot be changed later).
 */
- (nullable AmityObject<AmityMessage *> *)createFileMessageWithChannelId:(nonnull NSString *)channelId
