 ...
 */
- (nonnull AmityCollection<AmityCommunityMember *> *)getMembers:(AmityCommunityMembershipFilter)filter roles:(NSArray<NSString *> *)roles sortBy:(AmityCommunityMembershipSortOption)sortBy NS_SWIFT_NAME(getMembers(filter:roles:sortBy:));
