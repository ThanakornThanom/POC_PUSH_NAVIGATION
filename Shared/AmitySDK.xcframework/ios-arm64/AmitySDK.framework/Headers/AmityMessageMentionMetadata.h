...
/**
 AmityMessageMentionMetadata is a helper class, which helps:
 - to convert mentions from message metadata if metadata contains information about mentions,
 - to convert metadata from array of AmityMention objects.
 */
@interface AmityMessageMentionMetadata : NSObject

/**
 Converts the metadata into the array of AmityMention if metadata contains information about mentions.
 
 @param metadata The metadata of the message which supposed to contains information about mentions.
