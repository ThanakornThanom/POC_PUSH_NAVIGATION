...
- (void)registerDeviceWithUserId:(NSString * _Nonnull)userId displayName:(NSString * _Nullable)displayName authToken:(NSString * _Nullable)authToken completion:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable, BOOL))completion;
- (void)clearSession;
...
- (BOOL)shouldInvalidateSessionFor:(NSString * _Nonnull)userId SWIFT_WARN_UNUSED_RESULT;
...
///
/// returns:
/// URL for particular network type
- (NSURL * _Nonnull)getEndpointWithNetworkType:(enum ASCNetworkType)networkType SWIFT_WARN_UNUSED_RESULT;
...
- (NSURL * _Nullable)getRequestURLWithType:(enum ASCNetworkType)type path:(NSString * _Nonnull)path SWIFT_WARN_UNUSED_RESULT;
- (NSURL * _Nonnull)getEndpointWithNetworkType:(enum ASCNetworkType)networkType SWIFT_WARN_UNUSED_RESULT;
- (void)setAlternateHttpEndpointWithEndpoint:(NSString * _Nonnull)endpoint;
/// Sets the domain key
/// \param endpoint Alternate socket endpoint set by client
///
- (void)setAlternateSocketEndpointWithEndpoint:(NSString * _Nonnull)endpoint;
...
- (void)clearSession;
/// Session should be invalidated if existing userId is not same as provided user id
- (BOOL)shouldInvalidateSessionFor:(NSString * _Nonnull)userId SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8AmitySDK26AmityCommunityChannelQuery")
@interface AmityCommunityChannelQuery : AmityChannelQuery
- (nonnull instancetype)initWithBuilder:(AmityCommunityChannelQueryBuilder * _Nonnull)builder client:(AmityClient * _Nonnull)client OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC8AmitySDK33AmityCommunityChannelQueryBuilder")
@interface AmityCommunityChannelQueryBuilder : NSObject
- (nonnull instancetype)initWithFilter:(AmityChannelQueryFilter)filter includingTags:(NSArray<NSString *> * _Nonnull)includingTags excludingTags:(NSArray<NSString *> * _Nonnull)excludingTags includeDeleted:(BOOL)includeDeleted OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC8AmitySDK21AmityLiveChannelQuery")
@interface AmityLiveChannelQuery : AmityChannelQuery
- (nonnull instancetype)initWithBuilder:(AmityLiveChannelQueryBuilder * _Nonnull)builder client:(AmityClient * _Nonnull)client OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC8AmitySDK28AmityLiveChannelQueryBuilder")
@interface AmityLiveChannelQueryBuilder : NSObject
...
- (NSDictionary<NSString *, id> * _Null_unspecified)buildForPostUpdateV3 SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC8AmitySDK21AmityRegionalEndpoint")
