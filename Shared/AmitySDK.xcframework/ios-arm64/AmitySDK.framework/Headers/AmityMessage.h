...
/**
 The users who has beed mentioned in the current message
 */
@property (nullable, strong, readonly, nonatomic) NSArray<AmityUser*> *mentionedUsers;
...
/**
 * The mentionees propery provides information about mention tye and userIds if mention type is user.
 */
